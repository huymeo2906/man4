...
import styles from "./ProfileChangePasswordDe.module.css";
const ProfileChangePasswordDe = () => {
  const onMennuContainer3Click = useCallback(() => {
    // Please sync "My Tasks" to the project
  }, []);
  ...
  return (
    <div className={styles.profileChangePasswordDe}>
          ...
          <div className={styles.inputParent}>
            <div className={styles.input1}>
              ...
              <div className={styles.input2}>
                ...
                />
                <div className={styles.hmNayWrapper}>
                  <div className={styles.search}>Nhập mật khẩu cũ</div>
